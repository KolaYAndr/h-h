...
import com.example.myapplication.data.repository.AccessRepository_Factory;
...
import com.example.myapplication.domen.usecase.ProductUseCase_Factory;
...
import com.example.myapplication.presentation.ui.fragments.catalog_fragment.CatalogFragment_MembersInjector;
import com.example.myapplication.presentation.ui.fragments.catalog_fragment.CatalogViewModel;
import com.example.myapplication.presentation.ui.fragments.catalog_fragment.CatalogViewModel_Factory;
...
public final class DaggerApplicationComponent {
  ...
  private static final class CatalogFragmentSubcomponentImpl implements FragmentModule_CatalogFragment.CatalogFragmentSubcomponent {
    ...
    public void inject(CatalogFragment arg0) {
      injectCatalogFragment(arg0);
    }

    private CatalogFragment injectCatalogFragment(CatalogFragment instance) {
      CatalogFragment_MembersInjector.injectViewModelFactory(instance, applicationComponentImpl.viewModelFactoryProvider.get());
      return instance;
    }
  }
  ...
  private static final class ApplicationComponentImpl implements ApplicationComponent {
    ...
    private void initialize(final NetworkModule networkModuleParam,
      ...
      this.accessRepositoryProvider = AccessRepository_Factory.create(provideApiServiceProvider);
      this.loginUseCaseProvider = LoginUseCase_Factory.create(accessRepositoryProvider, preferenceStorageProvider);
      this.signInViewModelProvider = SignInViewModel_Factory.create(loginUseCaseProvider);
      this.productUseCaseProvider = ProductUseCase_Factory.create(accessRepositoryProvider);
      this.catalogViewModelProvider = CatalogViewModel_Factory.create(productUseCaseProvider);
      this.mapOfClassOfAndProviderOfViewModelProvider = MapProviderFactory.<Class<? extends ViewModel>, ViewModel>builder(2).put(SignInViewModel.class, ((Provider) signInViewModelProvider)).put(CatalogViewModel.class, ((Provider) catalogViewModelProvider)).build();
